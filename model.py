...
class Sc2Network():
    ...
    def _create_model():
        model = Sequential()
        model.add(Dense(units=128, activation='relu', input_dim=(108)))
        model.add(Dense(64))
        model.add(Dense(32))
    ...
    def train_model(self, dataFile='replays/replays_formated_data.txt', epochs=5, batch_size=32, min_score=0, verbose=0):
